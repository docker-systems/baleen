...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'job_job', (
            ...
            ('github_data', self.gf('jsonfield.fields.JSONField')(null=True, blank=True)),
            ('commit', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('build_definition', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('build_definition_type', self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True)),
            ('stash', self.gf('jsonfield.fields.JSONField')(null=True, blank=True)),
